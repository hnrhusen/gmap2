                                                    ...
                                                    <?php foreach ($groups as $group) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="button" name="" value="<?php echo $this->lang->line('table_edit');?>">
                                                                </a>
                                                                
                                                    <a class="group_delete" data-id="<?php echo $group['id'];?>" href="#">
                                                     <input type="button" name="" value="<?php echo $this->lang->line('table_delete');?>">
                                                    </a>
...
//                                                                return false;
                                                ...
                                                //user delete start
                                                    $('.group_delete').live('click', function(e) {
                                                        e.preventDefault();
                                                        var group_id = $(this).attr('data-id');
