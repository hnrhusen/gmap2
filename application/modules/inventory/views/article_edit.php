...
<title>Linux | Article Edit</title>
</head>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
						<?php  echo $this->lang->line('dashboard_location_editarticle'); ?>
							</div>
							
						</div>
						 <?php
                                                                            foreach ($get_articles as $get_article) {
                                                                            $good_article_id=$get_article['id'];?>
						<div class="portlet-body">
						<div id="error" style="padding-left: 220px;color: red;display:none;"></div>	
							<form action="<?php echo base_url(); ?>inventory/articles/<?php echo  $good_article_id; ?>" class="form-horizontal" onsubmit="return validategoodarticleeditForm()" method="post">
											<div class="form-body">
                                                <div class="row ">
													<div class="col-md-6">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
                                                                        <select name="goods_floor" class="form-control building-select">

                                                                            <?php
                                                                            foreach ($first_floor as $first_floors){
                                                                            if($first_floors["id"] == $get_article['office_id'])
                                                                            {
                                                ...
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-8">
                                                                        <select name="goods_office" class="form-control building-select">

                                                                           <?php
                                                                            foreach ($first_office as $first_offices){
                                                                            if($first_floors["id"] == $get_article['floor_id'])
                                                                            {
                                                ...
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" id="article_brand" name="article_brand" value="<?php echo $get_article['brand'];?>" >
						 ...
						 <label class="control-label col-md-3"><?php echo $this->lang->line('dashboard_location_model'); ?></label>
															<div class="col-md-9">
																<input type="text" class="form-control" value="<?php echo $get_article['model'];?>" id="article_model" name="article_model">
                                                ...
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" id="article_serial" name="article_serial" value="<?php echo $get_article['serial'];?>">
                                                ...
                                                <div class="row">
													<div class="col-md-6">
														<div class="form-group">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <input type="text" class="form-control" id="article_description"  name="article_description" value="<?php echo $get_article['description'];?>">
                                                                    </div>
                                                                </div>
													...
													<!--/span-->
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label col-md-3"><p style="margin-left:-10px;"><?php echo $this->lang->line('dashboard_location_divestiture'); ?></p></label>
                                                                    <div class="col-md-9">
                                                                        <input name="article_divestiture"  class="form-control" id="article_divestiture" type="text" value="<?php echo $get_article['divestiture'];?>">
...
<?php $this->load->view('dashboard/footer'); ?>
        ...
        <script>
            ...
            function validategoodarticleeditForm() {
