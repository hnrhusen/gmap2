...
<!--                                                <td>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url().'assets/img/inventory_uploads/'.$log['image'];?>" download="<?php echo $log['image'];?>" title="<?php echo $log['image'];?>"><button><?php echo $this->lang->line('download');?></button></a>
...
<script>
    jQuery(document).ready(function() {
                                                   ...
                                                   //log delete start
                                                    $('.log_delete').live('click', function(e) {
                                                        e.preventDefault();
